...
namespace GharAwas
{
    public static class BLMail
    {
        public static string SendMail(string To, string Subject, string Body, bool IsHTML)
        {
            try
            {
                var fromAddress = new MailAddress("coustomer.GharAwas@gmail.com");
                ...
                System.Net.Mail.SmtpClient smtp = new System.Net.Mail.SmtpClient
                {
                    ...
                    Credentials = new NetworkCredential(fromAddress.Address, "GharAwas@2022")
        ...
        public static void SendRegistrationMail(string UserName, string LoginId, string Password,  string Subject, string MailId)
        {
            ...
            message.From = new MailAddress("coustomer.GharAwas@gmail.com");
            ...
            smtp.Credentials = new NetworkCredential("coustomer.GharAwas@gmail.com", "GharAwas@2022");
